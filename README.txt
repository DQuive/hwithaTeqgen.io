Hwitha Training academy powered by TeqGen express
Teqgenexpress.com| @DQuive
Free for personal and commercial use under the CCA 3.0 license (html5up.net/license)


Say hello to Hwitha, my first addition to HTML5 UP in more than a year (!!!).
...
Credits:
	...
	Other:
		jQuery (jquery.com)
		Responsive Tools (github.com/Teqgen/responsive-tools)